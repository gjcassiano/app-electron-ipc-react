...
const TitleBar: React.FC = function () {
	return (
		<div className="title">
			...
			<IconButton
				className="btn-minimaze"
				onClick={() => ipcRenderer.send(IpcMessages.MINIMIZE)}
			>
				<div className="icon-minimaze"></div>
				<MinimizeSharpIcon></MinimizeSharpIcon>
			</IconButton>
			<IconButton
				className="btn-close"
				onClick={() => ipcRenderer.send(IpcMessages.QUIT)}
			>
